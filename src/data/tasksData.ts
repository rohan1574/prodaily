const tasksData: Record<string, any> = {
  ...
  "Breathing Exercises": require('../../assets/images/Wellness/breathing.png'),
  Journaling: require('../../assets/images/Wellness/journaling.png'),
  Mindfulness: require('../../assets/images/Wellness/mindfulness.png'),
  "Gratitude Practice": require('../../assets/images/Wellness/gratitude.png'),
  Relaxation: require('../../assets/images/Wellness/relaxation.png'),
  "Digital Detox": require('../../assets/images/Wellness/digital_detox.png'),
  "Fun Activities": require('../../assets/images/Wellness/fun_activities.png'),
  Laughing: require('../../assets/images/Wellness/laughing.png'),
  Activities: require('../../assets/images/Wellness/activities.png'),
  "Watching Comedies": require('../../assets/images/Wellness/comedies.png'),
  "Barefoot Earth Touching": require('../../assets/images/Wellness/earthing.png')
},
